...
<head>
	...
	<script type="text/javascript">
		function sendAddress(zipcode, address) {
			...
			//zipcode는 우편번호, address는 주소
			/* alert(zipcode + '/' + address) ;  */
			//opener : 나 자신을 open 시킨 창
			opener.document.myform.zipcode.value = zipcode; // 우편 번호
			opener.document.myform.fakezipcode.value = zipcode; // 가짜 우편 번호 
			opener.document.myform.fakeaddress1.value = address; // 가짜 주소 01
			opener.document.myform.address1.value = address; // 주소 01
			opener.document.myform.address2.focus(); // 주소 02에 포커스 주기
	...
	<div class="container col-sm-offset-<%=myoffset%> col-sm-<%=mywidth%>">
		<div class="panel panel-default panel-primary">
			...
			<div class="panel-body">
				<form name="myform" class="form-inline" role="form" method="get" action="<%=contextPath%>/zipcheck.me" >
