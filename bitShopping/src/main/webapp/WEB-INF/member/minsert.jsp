		...
		<div class="panel panel-body">
			...
			<%-- <div class="form-group">
				...
				<div class="col-sm-7" style="margin-top: 5px;">
					...
					<div class="col-sm-2" align="right" style="margin-bottom: 15px;">
						<input type="button" onclick="sample4_execDaumPostcode()"
							class="w3-btn w3-white w3-border w3-border-purple w3-round-large"
							style="font-weight: bold;" value="주소 찾기" onclick="javascript:findZipcode();"><br>
					</div>
					<input type="text" id="sample4_roadAddress" placeholder="도로명주소"
						 disabled="disabled" name="address2" class="form-control" value="${sample4_roadAddress}">
						<span id="guide" style="color:#999;display:none">
						</span>
					<input type="text" id="sample4_detailAddress" placeholder="상세주소"
						class="form-control" value="${sample4_detailAddress}">
				</div>
			</div> --%>
			<!-- -------------------------------------------------------------------------------- -->
			<div class="form-group">
...
<br><br><br>
<a href="<%=contextPath%>/delete.me">회원 탈퇴하기</a>
</body>
</html>